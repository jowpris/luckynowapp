...
//            mParam2 = getArguments().getString(ARG_PARAM2);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //Button btn_premios = (Button)view.findViewById(R.id.btn_premios);
        //Log.d("Boton premios", ""+btn_premios);
        //btn_premios.setVisibility(View.VISIBLE);
        /*btn_premios.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(v.getContext(), "Pronto podras reclamar tus premios", Toast.LENGTH_LONG).show();
            }
        })*/;
        return view;
    }
